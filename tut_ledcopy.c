// COMPILE AND RUN : gcc -o t2 trafficlights.c && sudo ./t2
...
int main(void)
{
    ...
    //(gpio + 1) = ((gpio + 1) & ~(7 << 0)) | (1 << 0) ;  // fSel = 1; shift = 0*3 = 0
    ...
    //(gpio + 1) = ((gpio + 1) & ~(7 << 3)) | (1 << 3) ;  // fSel = 1; shift = 1*3 = 3
    ...
    //(gpio + 1) = ((gpio + 1) & ~(7 << 9)) | (1 << 9) ;  // fSel = 1; shift = 3*3 = 9
